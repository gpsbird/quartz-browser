...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(30, 270, 629, 128))
        ...
        self.gridLayout.addWidget(self.label_sans, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.sansfontCombo, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinFontSize, 2, 1, 1, 1)
        self.checkMaximize = QtGui.QCheckBox(self.groupBox_2)
        self.checkMaximize.setObjectName(_fromUtf8("checkMaximize"))
        self.gridLayout.addWidget(self.checkMaximize, 0, 0, 1, 2)
        self.label_standard = QtGui.QLabel(self.groupBox_2)
        self.label_standard.setObjectName(_fromUtf8("label_standard"))
        self.gridLayout.addWidget(self.label_standard, 0, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.standardfontCombo, 0, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.seriffontCombo, 3, 3, 1, 1)
        self.label_serif = QtGui.QLabel(self.groupBox_2)
        self.label_serif.setObjectName(_fromUtf8("label_serif"))
        self.gridLayout.addWidget(self.label_serif, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.fixedfontCombo, 3, 1, 1, 1)
